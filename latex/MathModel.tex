...
\begin{figure}[!htbp]
\centering
\includegraphics[width=.7\textwidth]{logo2025.png}
\caption{对雷达实施距离多假目标欺骗干扰示意图}
\label{fig:radar-fake-1}
\end{figure}
\begin{figure}[!htbp]
\centering
\includegraphics[width=.7\textwidth]{logo2025.png}
\caption{对雷达实施距离多假目标欺骗干扰示意图}
\label{fig:radar-fake-2}
\end{figure}
