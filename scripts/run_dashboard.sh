...
export ESG_MINERU_BIN="${ESG_MINERU_BIN:-/home/sues01/.conda/envs/mineru/bin/mineru}"
DASHBOARD_PYTHON="${ESG_DASHBOARD_PYTHON_BIN:-/home/sues01/.conda/envs/paperagent/bin/python}"
...
if ! curl -fsS "${ESG_OLLAMA_HEALTH_URL:-http://127.0.0.1:11434/api/tags}" >/dev/null 2>&1; then
