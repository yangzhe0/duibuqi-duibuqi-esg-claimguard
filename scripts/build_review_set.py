...
FINAL_ROOT = PROJECT_ROOT / "outputs/final_results"
DEFAULT_RESULTS = FINAL_ROOT / "extraction/extraction_results.csv"
DEFAULT_POOL = FINAL_ROOT / "indicator_pool.csv"
DEFAULT_OUT_DIR = FINAL_ROOT / "review"
